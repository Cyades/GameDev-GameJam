...
@export var hurtbox_radius: float = 32.0
@export var contact_hitbox_radius: float = 28.0
@export var hp_bar_world_offset: Vector2 = Vector2(-25.0, -95.0)
...
func _setup_hp_bar() -> void:
	...
	hp_bar.scale = Vector2(0.8, 0.8) / parent_scale
