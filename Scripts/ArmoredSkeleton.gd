...
## Armored Skeleton — Tanky skeleton enemy
...
@export var hurtbox_radius: float = 13.0
@export var contact_hitbox_radius: float = 11.0
...
func _on_animation_finished() -> void:
	if animated_sprite.animation == &"death":
		ExpGemScript.drop_gems(self, 1, 1)  # Mid tier, 1 gem
		queue_free(); return
...
func _on_frame_changed() -> void:
	...
	elif anim == &"attack02" and f == 0: CombatSound.play_random_slash(self)
